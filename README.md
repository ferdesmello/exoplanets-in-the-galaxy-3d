...
There have been <!--EXOPLANETS-->6028<!--EXOPLANETS--> exoplanets discovered around <!--STARS-->4500<!--STARS--> stars. But only <!--SDIST-->4474<!--SDIST--> of those stars have had their distance to us determined; totalizing <!--PDIST-->6002<!--PDIST--> exoplanets in the visualization.
...
Date of the last (automatic) update: <!--LAST_UPDATE-->2025-10-20<!--END_LAST_UPDATE-->
