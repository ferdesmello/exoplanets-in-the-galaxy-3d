...
There have been <!--EXOPLANETS-->6045<!--EXOPLANETS--> exoplanets discovered around <!--STARS-->4509<!--STARS--> stars. But only <!--SDIST-->4483<!--SDIST--> of those stars have had their distance to us determined, totaling <!--PDIST-->6019<!--PDIST--> exoplanets in the visualization.
...
Date of the last (automatic) update: <!--LAST_UPDATE-->2025-11-15<!--END_LAST_UPDATE-->
