...
There have been <!--EXOPLANETS-->6291<!--EXOPLANETS--> exoplanets discovered around <!--STARS-->4709<!--STARS--> stars. But only <!--SDIST-->4682<!--SDIST--> of those stars have had their distances to us determined, totaling <!--PDIST-->6264<!--PDIST--> exoplanets in the visualization.
...
Date of the last (automatic) update: <!--LAST_UPDATE-->2026-06-01<!--END_LAST_UPDATE-->
