...
There have been <!--EXOPLANETS-->6278<!--EXOPLANETS--> exoplanets discovered around <!--STARS-->4705<!--STARS--> stars. But only <!--SDIST-->4678<!--SDIST--> of those stars have had their distances to us determined, totaling <!--PDIST-->6251<!--PDIST--> exoplanets in the visualization.
...
Date of the last (automatic) update: <!--LAST_UPDATE-->2026-05-01<!--END_LAST_UPDATE-->
