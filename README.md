...
There have been <!--EXOPLANETS-->6128<!--EXOPLANETS--> exoplanets discovered around <!--STARS-->4566<!--STARS--> stars. But only <!--SDIST-->4539<!--SDIST--> of those stars have had their distance to us determined, totaling <!--PDIST-->6101<!--PDIST--> exoplanets in the visualization.
...
Date of the last (automatic) update: <!--LAST_UPDATE-->2026-03-01<!--END_LAST_UPDATE-->
