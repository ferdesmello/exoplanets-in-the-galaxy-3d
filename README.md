...
There have been <!--EXOPLANETS-->6298<!--EXOPLANETS--> exoplanets discovered around <!--STARS-->4716<!--STARS--> stars. But only <!--SDIST-->4689<!--SDIST--> of those stars have had their distances to us determined, totaling <!--PDIST-->6271<!--PDIST--> exoplanets in the visualization.
...
Date of the last (automatic) update: <!--LAST_UPDATE-->2026-06-15<!--END_LAST_UPDATE-->
