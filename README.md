...
There have been <!--EXOPLANETS-->6087<!--EXOPLANETS--> exoplanets discovered around <!--STARS-->4541<!--STARS--> stars. But only <!--SDIST-->4514<!--SDIST--> of those stars have had their distance to us determined, totaling <!--PDIST-->6060<!--PDIST--> exoplanets in the visualization.
...
Date of the last (automatic) update: <!--LAST_UPDATE-->2026-02-04<!--END_LAST_UPDATE-->
