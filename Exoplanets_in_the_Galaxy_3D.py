...
image_rgba = image2.convert("RGBA")

# Resize the image for better performance
smaller_dim = (100, 100)
image_resized = image2.resize(smaller_dim, PIL.Image.Resampling.LANCZOS)#.resize(smaller_dim, Image.ANTIALIAS)
...
ax.set_xlim(-68000, 68000)
ax.set_ylim(-68000, 68000)
ax.set_zlim(-68000, 68000)
